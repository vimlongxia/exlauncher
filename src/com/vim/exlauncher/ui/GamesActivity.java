...
public class GamesActivity extends Activity {
    ...
    private final String[] mGameList = new String[] {
            "com.rovio.angrybirdsrio", // angry birds
            "com.lemuellabs.fireworks", // cutting fruits
    };
        ...
        if (apps != null) {
            ...
            for (int j = 0; j < mGameList.length; j++) {
                for (int i = 0; i < count; i++) {
                    ...
                    Log.i("GamesActivity", "" + application.title.toString());

                    if (info.activityInfo.applicationInfo.packageName
                            .contains(mGameList[j])) {
